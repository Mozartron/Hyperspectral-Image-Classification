...
uPavia = sio.loadmat('./drive/My Drive/Residual_HSI-Colab/SSRN/datasets/UP/PaviaU.mat')
gt_uPavia = sio.loadmat('./drive/My Drive/Residual_HSI-Colab/SSRN/datasets/UP/PaviaU_gt.mat')
...
for index_iter in range(ITER):
    ...
    best_weights_RES_path_ss4 = './drive/My Drive/Residual_HSI-Colab/SSRN/models/UP_best_RES_3D_SS4_5_' + str(index_iter + 1) + '.hdf5'
...
# load trained model
    ...
    classification_map(y_re, gt_IN, 24, "./drive/My Drive/Residual_HSI-Colab/SSRN/Cmaps/RES4_SS_UP_new.png")
