...
mat_gt = scipy.io.loadmat('./drive/My Drive/Residual_HSI-Colab/SSRN/datasets/UP/PaviaU_gt.mat')
gt = mat_gt['paviaU_gt']

mat_data = scipy.io.loadmat('./drive/My Drive/Residual_HSI-Colab/SSRN/datasets/UP/PaviaU.mat')
...
plt.imshow(rgb_hsi)
plt.show()
plt.savefig('output_pavia_gt.png')
