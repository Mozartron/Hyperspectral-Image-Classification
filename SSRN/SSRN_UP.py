...
uPavia = sio.loadmat('./drive/My Drive/Residual_HSI-Colab/SSRN/datasets/UP/mod_pavia.mat')
gt_uPavia = sio.loadmat('./drive/My Drive/Residual_HSI-Colab/SSRN/datasets/UP/mod_pavia_gt.mat')
...
for index_iter in range(ITER):
    ...
    best_weights_RES_path_ss4 = './drive/My Drive/Residual_HSI-Colab/SSRN/models/UP_mod_best_RES_3D_SS4_5_' +  str(index_iter+1) +'.hdf5'
