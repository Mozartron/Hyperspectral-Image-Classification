...
mat_data = sio.loadmat('./drive/My Drive/Colab/SSRN/datasets/IN/Indian_pines_corrected.mat')
data_IN = mat_data['indian_pines_corrected']
mat_gt = sio.loadmat('./drive/My Drive/Colab/SSRN/datasets/IN/Indian_pines_gt.mat')
...
for index_iter in range(ITER):
    ...
    best_weights_RES_path_ss4 = './drive/My Drive/Colab/SSRN/models/Indian_best_RES_3D_SS4_10_' + str(
        index_iter + 1) + '.hdf5'
...
#    train_indices, test_indices = sampleFixNum.samplingFixedNum(TRAIN_NUM, gt)
    ...
    classification_map(y_re, gt_IN, 24, "./drive/My Drive/Colab/SSRN/Cmaps/RES4_SS_IN_new.png")
